...
<body>
	...
	<form action="boardUpdate.do" method="post">
		제목 : <input type="text" name="title" value="${requestScope.tip_board.tb_title}"><br>
		작성일 : ${requestScope.tip_board.tb_date}<br>
		작성자 : ${requestScope.tip_board.tb_writer}
		내용<br>
		<textarea name="content">${requestScope.tip_board.tb_content}</textarea>
		<br>
		<button>수정</button>
		<button type="button" onclick="history.back();">취소</button>
		<input type="hidden" name="tbno" value="${requestScope.tip_board.tb_no}">
	</form>
	</section>

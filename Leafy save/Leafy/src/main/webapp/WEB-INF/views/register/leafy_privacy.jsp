...
<div>
        ...
        <p><b>제1조(목적)</b> <br>
            ...
            본 회원약관은 Lefay(이하 '갑'라 한다)이 운영하는 인터넷관련 개인정보이용약관(이하 '서비스'라 한다)를 이용함에 있어 관리자와 이용자(이하 '회원'라 한다)의 권리, 의무 및 책임사항을 규정함을 목적으로 한다. <br>
            <br>
            <b>제2조 (약관의 효력)</b><br>
            <br>
            ...
            부  칙<br>
            <br>
            제 1 조 (시행일) 이 약관은 2021년 10월 18일부터 시행한다.<br> </p>
            <button type="button" onclick="closeTabClick()" >닫기</button>
    </div>
